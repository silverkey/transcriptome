...
# PARAMETERS #
##############
my $folder = '/media/LOCAL_DATA_2/HCUN/mapping'; # complete path
my $index = '/media/LOCAL_DATA_2/HCUN/mapping/index/HCHUN_trinity_no_jaccard_assembly.fasta'; # complete path
my $outdir = '/media/LOCAL_DATA_2/HCUN/mapping'; # complete path - IT MUST EXIST: WILL NOT BE CREATED
my $core = 24;
my $chunkmbs = 10240;
my $maxins = 500;
my $trim5 = 20;
