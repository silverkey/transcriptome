...
my $index = '/home/remo/ANALYSIS/pmultistriata/FINAL/pmultistriata/mapping/index/pm_transcriptome_assembly_2013_10'; # complete path
my $outdir = '/media/LOCAL_DATA_2/multistriata/mapping_out'; # complete path - IT MUST EXIST: WILL NOT BE CREATED
my $core = 24;
my $chunkmbs = 10240;
my $maxins = 500;
my $trim5 = 20;
...
# Example of a successful run from the command line that we try to reproduce
