...
# PARAMETERS #
##############
my $folder = '/data01/ANALYSIS/octopus/raw_collated'; # complete path
my $index = '/data01/ANALYSIS/octopus/index/octopus_transcriptome_assembly_2013_10'; # complete path
my $outdir = '/data01/ANALYSIS/octopus/mapping_out'; # complete path - IT MUST EXIST: WILL NOT BE CREATED
my $core = 24;
my $chunkmbs = 10240;
my $maxins = 500;
my $trim5 = 2;
