...
# PARAMETERS #
##############
my $folder = '/media/LOCAL_DATA_2/srobusta/splitted_originl_data/mixed'; # complete path
my $index = '/media/LOCAL_DATA_2/srobusta/index/sr_transcriptome_assembly_2013_10'; # complete path
my $outdir = '/media/LOCAL_DATA_2/srobusta/splitted_originl_data/mixed_mapping_transcriptome_out'; # complete path - IT MUST EXIST: WILL NOT BE CREATED
my $core = 24;
my $chunkmbs = 10240;
my $maxins = 500;
my $trim5 = 20;
