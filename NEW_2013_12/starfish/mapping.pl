...
# PARAMETERS #
##############
my $folder = '/data01/ANALYSIS/starfish/FASTQ/RAW'; # complete path
my $index = '/data01/ANALYSIS/starfish/FASTQ/index/starfish_transcriptome_2013_10'; # complete path
my $outdir = '/data01/ANALYSIS/starfish/FASTQ/mapping_out'; # complete path - IT MUST EXIST: WILL NOT BE CREATED
my $core = 24;
my $chunkmbs = 10240;
my $maxins = 500;
my $trim5 = 0;
