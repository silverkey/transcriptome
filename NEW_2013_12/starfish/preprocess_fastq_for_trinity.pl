...
my $trimmomatic = '/home/standard/src/Trimmomatic-0.30/trimmomatic-0.30.jar';
my $illumina_adapters = 'illumina_adapters.fa';
my $trimmomatic_threads = '24';
my $trimmomatic_clip = '2:40:15';
my $trimmomatic_leading = '3';
my $trimmomatic_trailing = '3';
my $trimmomatic_sliding = '3:20';
my $trimmomatic_minlen = '25';
my $name_left = 'starfish_filt_left';
my $name_right = 'starfish_filt_right';
my $output_format = 'fastq';
my $seqfile_ending = '.fastq';
