...
samples$largemVSsmallm = c(0,2,1,0,2,0)

# Create the DGE object
dge = DGEList(counts, group=samples$largemVSsmallm)
...
write.table(counts.sig,file='large_minus_vs_small_minus_differentially_expressed_transcripts.txt',row.names=F,sep='\t',quote=F)
